    ...
    <section className="border-t border-zinc-200/80 bg-white pt-10 sm:pt-12">
      <header className="flex flex-col gap-6 border-b border-zinc-200/80 pb-8 lg:flex-row lg:items-end lg:justify-between">
        ...
        <label className="relative block w-full max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-sm border border-zinc-200 bg-white py-2.5 pl-10 pr-4 text-sm text-zinc-800 outline-none transition placeholder:text-zinc-400 focus:border-[#c8102e]/60 focus:ring-1 focus:ring-[#c8102e]/30"
          />
        </label>
      </header>
      ...
      <div className="mt-8 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4 lg:gap-6" role="list">
        {filteredItems.length === 0 ? (
          <p className="col-span-full rounded-xl border border-dashed border-zinc-200 px-6 py-14 text-center text-sm text-stone-500">
